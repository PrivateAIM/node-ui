...
* **analysis:** add extra toasts to analysis container controls build_image ([1c420e4](https://github.com/PrivateAIM/node-ui/commit/1c420e4a3ba0b04fbbdc86af5b3d31a21be99683))
...
* **analysis:** loading symbols to analysis container controls ([a9d7623](https://github.com/PrivateAIM/node-ui/commit/a9d762372bbd2c0d9b374f6f846acc61b823ae91))
...
* **api:** update hub adapter endpoints build_image ([38deb6b](https://github.com/PrivateAIM/node-ui/commit/38deb6b4c8aa8bdf44ea2c4aed5af51e374dbae8))
* **auth:** actual working login build_image ([d46412f](https://github.com/PrivateAIM/node-ui/commit/d46412f1ae40b4cfa8b5fe80ae03fcfe00b002df))
* **auth:** actual working login build_image ([e90a27b](https://github.com/PrivateAIM/node-ui/commit/e90a27b08d5b95b112ece387f2a5189900213ed7))
* **auth:** begin adding in sidebase ([769b1bb](https://github.com/PrivateAIM/node-ui/commit/769b1bb0fcb4858698e69e27243831c64b9e243f))
* **auth:** begin adding in sidebase ([fefc4fc](https://github.com/PrivateAIM/node-ui/commit/fefc4fc20d94590306d039bcdb566313146bbcab))
* **auth:** begin implementing keycloak-js ([f9189de](https://github.com/PrivateAIM/node-ui/commit/f9189de77fe99167c50d179dfce4c9399f2ea429))
...
* **auth:** quasi working oidc-client-ts ([44cc078](https://github.com/PrivateAIM/node-ui/commit/44cc0781d049f853580f96d5a75177f8222a7b7e))
* **auth:** quasi working oidc-client-ts ([8c36f43](https://github.com/PrivateAIM/node-ui/commit/8c36f436fd3ef3084a5e00db01122036049d9524))
...
* **auth:** update redirectUri build_image ([feb0a84](https://github.com/PrivateAIM/node-ui/commit/feb0a8426baf299005b2593523cd902e3845d1e5))
...
* **ci:** disable multi-platform workflow for ghcr build_image ([047d4f7](https://github.com/PrivateAIM/node-ui/commit/047d4f74c4dcc2de45d383f9c3cbc0477b8402f1))
...
* **kong:** change data store types to lower case build_image ([58749c9](https://github.com/PrivateAIM/node-ui/commit/58749c9847662a0d313d2b125d8cc8f5eefb33b9))
* **kong:** disable udp option ([b5f35f7](https://github.com/PrivateAIM/node-ui/commit/b5f35f75c222e9f2ec6d942c12aa2d690b23d018))
* **kong:** fix data store tabs from crashing build_image ([1884359](https://github.com/PrivateAIM/node-ui/commit/1884359464dbe7e1e394952bc0b830f8f89ce5ab))
...
* **logout:** change the logout EP for kc ([d42344b](https://github.com/PrivateAIM/node-ui/commit/d42344b7da78c6a6d82e1705122120cd72d5cbb2))
* **logout:** remove logout URL and let lib handle user session clearing ([4ab53de](https://github.com/PrivateAIM/node-ui/commit/4ab53de72cc921815a1ef75250750f6a610f9898))
...
* **token:** fix token error from nuxt-oidc-auth in k8s ([e56fae9](https://github.com/PrivateAIM/node-ui/commit/e56fae9d337f26f30ba88645483f88933b674f1d))
...
* **userinfo:** add default greetings in case userinfo endpoint fails build_image ([d28aa95](https://github.com/PrivateAIM/node-ui/commit/d28aa95102c30cfd3401f5a35fa9d87ff2c13d5b))
* **userinfo:** add key check for userinfo build_image ([8c37019](https://github.com/PrivateAIM/node-ui/commit/8c3701921a96bde78ef3a0945ad32d5e8e71bd19))
...
* **ci:** revert ghcr flow to single architecture to speed up image build ([61c783f](https://github.com/PrivateAIM/node-ui/commit/61c783fed31dc9391b9fd17ba1c464dd6f5ee795))
...
* **prod:** disable prod Dockerfile due to inability to dynamically update keycloak URL build_image ([3ae9ab0](https://github.com/PrivateAIM/node-ui/commit/3ae9ab096ef4a50bb5d32e1feee7eb98bcbb7254))
...
* **api:** update hub adapter api models to include updated AnalysisNodeRunStatus ([a360e8e](https://github.com/PrivateAIM/node-ui/commit/a360e8efe284771833aa3c34a52eb779d5f2ed57))
* **api:** update hub adapter endpoints build_image ([38deb6b](https://github.com/PrivateAIM/node-ui/commit/38deb6b4c8aa8bdf44ea2c4aed5af51e374dbae8))
* **api:** update hub adapter models ([4d6979c](https://github.com/PrivateAIM/node-ui/commit/4d6979cfa0a9047e709cdfdc7a487f62ce732f7e))
* **auth:** actual working login build_image ([d46412f](https://github.com/PrivateAIM/node-ui/commit/d46412f1ae40b4cfa8b5fe80ae03fcfe00b002df))
* **auth:** actual working login build_image ([e90a27b](https://github.com/PrivateAIM/node-ui/commit/e90a27b08d5b95b112ece387f2a5189900213ed7))
* **auth:** begin adding in sidebase ([769b1bb](https://github.com/PrivateAIM/node-ui/commit/769b1bb0fcb4858698e69e27243831c64b9e243f))
* **auth:** begin adding in sidebase ([fefc4fc](https://github.com/PrivateAIM/node-ui/commit/fefc4fc20d94590306d039bcdb566313146bbcab))
* **auth:** begin adding in sidebase ([8e44cdb](https://github.com/PrivateAIM/node-ui/commit/8e44cdb46460f3455e67038de7a930188e74a754))
* **auth:** begin implementing keycloak-js ([f9189de](https://github.com/PrivateAIM/node-ui/commit/f9189de77fe99167c50d179dfce4c9399f2ea429))
* **auth:** begin implementing keycloak-js ([6f78b66](https://github.com/PrivateAIM/node-ui/commit/6f78b66de2f8ab5c4da95df7a69c45afb2d8523f))
* **auth:** begin playing with sidebase ([a8a52b7](https://github.com/PrivateAIM/node-ui/commit/a8a52b747554ca1e6a90db6e24e00da7a7b8241d))
* **auth:** catch invalid credential error and notify user with toast ([a3f0c81](https://github.com/PrivateAIM/node-ui/commit/a3f0c816e3cac3bd95599d8ac657ccfe2a7aaed0))
* **auth:** catch invalid credential error and notify user with toast ([66fffcc](https://github.com/PrivateAIM/node-ui/commit/66fffcc26a26604d03ebed2113855150ab91b8ca))
* **auth:** enable gloabl auth but disable for landing ([28b8b82](https://github.com/PrivateAIM/node-ui/commit/28b8b82b4da381c25fddb4d7e93b2f035d151698))
...
* **logs:** working log parsing ([50504e9](https://github.com/PrivateAIM/node-ui/commit/50504e98abf7b2648123860dbd200769a9b0e44b))
* **middleware:** improve middleware for checking token expiration ([d53920f](https://github.com/PrivateAIM/node-ui/commit/d53920fb7b3a0d48cbefb2b3240cc942f0fde428))
* **podorc:** update passed params to podorc analysis creation buttons and table build_image ([c92044e](https://github.com/PrivateAIM/node-ui/commit/c92044e9b0a587f0e18e65af382a69dbddc30a0d))
* **projects:** continue adding proiject parsing to analysis table ([602c894](https://github.com/PrivateAIM/node-ui/commit/602c8942e174955d81e7abd391a939ba110091be))
* **robot:** parse the hub adapter response when improper robot id used ([ffb3f0f](https://github.com/PrivateAIM/node-ui/commit/ffb3f0f84752f57ba5a937520638d59ac52dc3a0))
* **robot:** parse the hub adapter response when improper robot id used ([37a0ea6](https://github.com/PrivateAIM/node-ui/commit/37a0ea6740bd040692e7eb1dec8fa23e8ac160e2))
* **search:** add clear filter button to all tables and update dates ([e0a231b](https://github.com/PrivateAIM/node-ui/commit/e0a231be8b1971866f157f0cacbecdbee66cf020))
