import type { ListProjectNodes } from "~/services/Api";
import { ApprovalStatus } from "~/services/Api";

export const fakeProposalsResp: ListProjectNodes = {
  data: [
    {
