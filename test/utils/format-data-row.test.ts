...
test("Format returned analysis data", () => {
  ...
  expect(baseNode.created_at).toBe("2025-01-28T14:58:12Z");
  expect(baseNode.updated_at).toBe("2025-03-18T09:11:14Z");
  ...
  expect(row.created_at).toStrictEqual({
    short: "28.01.2025",
    long: "28. Jan. 2025, 15:58",
    date: new Date("2025-01-28T14:58:12.000Z"),
    timestamp: 1738076292,
  ...
  expect(row.updated_at).toStrictEqual({
    short: "18.03.2025",
    long: "18. März 2025, 10:11",
    date: new Date("2025-03-18T09:11:14.000Z"),
    timestamp: 1742289074,
